...
import { DELETEEVENTLIST, GETEVENTLIST } from '@/lib/endpoint';
...
export const Route = createFileRoute('/_layout/events/upcoming')({
  component: Events,
...
function Events() {
  ...
  const { data, isFetching, refetch } = useQuery({
    queryKey: [GETEVENTLIST, page, limit, EVENTCATEGORY.UPCOMING,debouncedSearchQuery],
    queryFn: () => privateAxios({ url: GETEVENTLIST, data: { page, limit, search: debouncedSearchQuery, type: EVENTCATEGORY.UPCOMING } })
  });
